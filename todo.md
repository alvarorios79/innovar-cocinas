...
## Mini-Fase 19 - Notificaciones por Fases del Proyecto (Corte, Enchape, Armado, Instalación, Entrega)

### Fase 1 - Backend
- [x] Crear endpoint projects.sendSectionNotification en backend
- [x] Implementar lógica de construcción de mensajes dinámicos por sección
- [x] Integrar con WhatsApp Cloud API usando sendTextMessage()

### Fase 2 - Frontend
- [ ] Agregar botones "Notificar al cliente" en cada sección del proyecto
- [ ] Validar flujo en laptop, iPhone e iPad
- [ ] Confirmar que los enlaces de galería funcionan correctamente
