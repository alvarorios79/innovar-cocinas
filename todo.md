...
## Ajustes según Feedback - Ene 23, 2026

### Simplificar Vista de Proyectos
- [x] Mover botones de acciones (Confirmar Adelanto, Iniciar Diseño, WhatsApp, PDF, Fotos, Nota, Fechas) a la vista principal expandida
- [x] Eliminar el botón/sección "Detalle" - ahora las acciones están directamente en la tarjeta expandida
- [x] Mantener la estructura de tabs (Info, Fechas, Fotos, Historial) con acciones visibles directamente
- [x] Agregar visualización del monto de adelanto en la sección de Fechas

### Corregir Nombre del PDF Descargado
- [x] Cambiar formato de nombre de archivo de quotation_XXX_timestamp.pdf a COT-XXXX-XXX_NombreCliente.pdf
- [x] Limpiar caracteres especiales del nombre para compatibilidad con sistemas de archivos (tildes permitidas)

### Monto de Adelanto 60% Fijo
- [x] Cambiar campo de monto de adelanto para que sea 60% fijo del total (no editable)
- [x] Mostrar el cálculo automático del 60% al cliente con desglose visual
- [ ] Actualizar el mensaje informativo sobre el adelanto requerido
